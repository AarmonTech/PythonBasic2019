...
while(b >= 100):
	print(1)
	b = input("Enter b : ")#you would arrive at error here, fix it
	if(b == 188):
		continue
	print(3)
print(4)
...
while(wish == "y"):
	print ("This lrintoop will continue untill my wish is not y")
...
string = "Prashant, Tiwari, Mohit, Prashant"



sharks = ["divy", "appl","clas"]
